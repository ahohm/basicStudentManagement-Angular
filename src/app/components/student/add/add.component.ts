  ...
  createForm(data){
    if (data == null) {
      this.studentAddForm = this.formBuilder.group({
        ...
        phone: ['',  [Validators.required,ValidationService.checkLimit(20000000,9999999999)]],
      ...
      this.studentAddForm = this.formBuilder.group({
        ...
        phone: [data.studentData.phone,  [Validators.required,ValidationService.checkLimit(2000000,9999999999)]],
